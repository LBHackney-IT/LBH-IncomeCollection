...
# FIXME: MERGE this with @el's work related to sending
...
describe 'Viewing A Letter Preview' do
  ...
  scenario 'End to End letters', js: true do
    ...
    then_i_submit_send_letter_button
  end
  ...
  def then_i_submit_send_letter_button

    letter_div = find('.letter')
    expect(letter_div["data-uuid"]).to eq(uuid)
require 'pry' ;    binding.pry

    letter_div.click_button('Confirm and Send')
